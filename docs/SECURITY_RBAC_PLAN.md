...
- All live-verified on testbed-client (legacy-hash upgrade observed in DB; 429 lockout growth 60s→120s; concurrent burst 10×401+5×429; CORS all three modes; viewer proxy GET 200; 8h token TTL).
