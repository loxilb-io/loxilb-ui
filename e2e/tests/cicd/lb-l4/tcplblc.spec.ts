//---------------------------------------------------------
// cicd source: cicd/tcplblc — select=lc (least-connections).
//   create_lb_rule llb1 <vip> --tcp=2020:8080 --endpoints=…:1 --select lc
...
test.describe('cicd/tcplblc — select=lc (least-connections)', () => {
