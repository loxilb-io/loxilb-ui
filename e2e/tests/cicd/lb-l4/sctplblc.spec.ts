//---------------------------------------------------------
// cicd source: cicd/sctplblc — SCTP + select=lc.
//   create_lb_rule llb1 <vip> --sctp=2020:8080 --endpoints=…:1 --select lc
...
test.describe('cicd/sctplblc — SCTP + select=lc', () => {
