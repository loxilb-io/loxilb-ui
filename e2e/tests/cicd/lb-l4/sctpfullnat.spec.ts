//---------------------------------------------------------
// cicd source: cicd/sctpfullnat — SCTP fullnat (38412→38412).
...
const recipe: LbRecipe = {
	cicd: 'cicd/sctpfullnat',
	name: 'e2e-cicd-sctpfullnat',
	vip: "203.0.113.44",
	port: "38412",
	protocol: "sctp",
	mode: "fullnat",
...
test.describe('cicd/sctpfullnat — SCTP fullnat (38412→38412)', () => {
