...
//---------------------------------------------------------
export default function ProcessTable(props: {data: IProcessInfo; selected_rows: number[]; onChangeSelectedRows: any}) {
	...
	return <DataTable name={'Process'} columns={cols} rows={rows} selected_rows={selected_rows} onChangeSelectedRows={onChangeSelectedRows} hideMenuBar />;
}
