...
// Imports
//---------------------------------------------------------
import {Box, Divider, Stack, Typography, FormControl, InputLabel, Select, MenuItem, TextField, Button, Chip, IconButton, Tooltip} from '@mui/material';
	...
	return (
		<ScrollableBox>
			<Stack position="relative" id="fixed-container" width="100%" height="100%" spacing={3} padding="16px">
				...
				<LogTable data={allLogs} selected_rows={selected_rows} onChangeSelectedRows={set_selected_rows} />
