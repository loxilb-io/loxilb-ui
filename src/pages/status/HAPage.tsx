...
export default function HAPage() {
	...
	const ha_query = useHAState(inst);
	const {data, refetch} = ha_query; // IVipAttribute[]
	...
	return <HATable data={ha_info} selected_rows={selected_rows} onChangeSelectedRows={set_selected_rows} onEdit={handleEdit} onRefresh={refetch} state={toPageState(ha_query, {op: 'ha_state.list'})} />;
}
